...
if ($_SERVER['HTTP_HOST'] === 'localhost') {
    // Local setup
    $config['base_url'] = 'http://localhost/pet/';
} else {
    // Live setup (auto-detect)
    $protocol = (
        isset($_SERVER['HTTPS']) && 
...
if ($_SERVER['HTTP_HOST'] === 'localhost') {
    $config['uploads_base_url'] = 'https://mypupcentral.com/uploads/';
} else {
    $config['uploads_base_url'] = base_url('uploads/');
}
