        ...
        <div class="row">
            <div class="col-md-12">
                        ...
                        <select class="form-control" name="category">
                          ...
                          <?php if($category){
                            foreach ($category as $key => $value) { ?>
                              <option <?php if($value->id == $blog->category_id){echo 'selected'; }?> value="<?php echo $value->id?>"><?= $value->category?></option>
                ...
                <div class="row">
                      ...
                      <div class="input-group mb-3">
                        <input type="text" name="author" required="" value="<?=$blog->author?>" class="form-control" placeholder="Author">
                        <div class="input-group-append">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                     ...
                     <!--    <input type="text" name="description" id="description" required="" class="form-control" placeholder="Title"> -->
                       <textarea id="" name="s_description"  class="form-control"><?=$blog->short_description?></textarea>
                      </div>
                    </div>                   
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                      ...
                      <div class="input-group mb-3">
                        <input type="text" name="meta_keyword"  class="form-control" placeholder="Meta Keyword" value="<?=$blog->meta_keyword?>">
                        <div class="input-group-append">
                          <div class="input-group-text"> <span class="fab fa-blogger-b"></span> </div>
                        </div>
                      </div>
...
<script>
      ...
      CKEDITOR.replace('description',
    {
		...
		var data = new FormData(form);
              ...
              url:baseurl+"admin/blogs/save_edit/<?=$blog->id?>",  
              method: "post",
        			data: data,
