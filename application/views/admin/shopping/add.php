...
<section class="content">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="input-group mb-3">
                       ...
                       <textarea id="" name="note" class="form-control"></textarea>
                      </div>
                    </div>                   
 ...
 <div class="row">
                 ...
                 <div class="row">
                      ...
                      <div class="input-group mb-3">
                        <input type="file" name="image1" required="" class="form-control" placeholder="Title">
...
<script>
      ...
      CKEDITOR.replace('description',
    {
		...
		var data = new FormData(form);
              ...
              url:baseurl+"admin/shopping/save",  
              method: "post",
        			data: data,
