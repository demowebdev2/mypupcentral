                      ...
                      <div class="card-body">
                        <div class="tab-content">
                          ...
                          <div class="tab-pane <?php if($nav=='change_password') echo 'active' ?>" id="settings">
                              <div class="col-md-6">
                              <form id="form1" action="<?php echo site_url('admin/Admin/change_password') ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">     <div class="box-body">
