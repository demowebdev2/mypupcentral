    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-9 page-content">
          ...
          <div class="inner-box">
            <form id="form" method="POST" action="<?= base_url() ?>addad" enctype="multipart/form-data">
              ...
              <!-- <ul id="progressbar">
                ...
                <li id="step5" style="text-align: center;"><strong>Go Premium</strong></li>
              </ul> -->
              <!-- <div class="progress">
              ...
              <fieldset>
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <?php if (!empty($ads)) { ?>
                      <a href="<?= base_url() ?>posts/duplicatead/<?= $ads[0]->id ?>">
                        <button type="button" style="color:#000" class="btn btn-light-blue">Load Info From Previous Ad</button>
                      </a>
                    <?php } ?>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <!--  <label for="ad_title">Load Info From Previous Listing</label>-->
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="ad_title" class="form-control" id="ad_title" placeholder="Enter Puppy Name" required spellcheck="true">
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-md-12">
                    <textarea class="form-control" id="description" required name="description" rows="5" style="height: 50px" spellcheck="true"></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label for="puppy_dob">Puppy DOB<span style="color:red;">*</span></label>
                  <input type="text" name="puppy_dob" class="form-control " id="puppy_dob" placeholder="Enter Puppy DOB" required>
                ...
                <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="email">Contact Email (If Any)</label>
                ...
                <!-- <input type="button" name="next-step" class="next-step one" value="Next Step" /> -->
                <!-- </fieldset>
              <fieldset> -->
                <h2>More About Puppy </h2>
                <!--        <div class="form-group">-->
                <!--    <label for="puppy_name">Puppy Name<span style="color:red;">*</span></label>-->
                <!--    <input type="text" name="puppy_name" class="form-control" id="puppy_name" placeholder="Enter Puppy Name">-->
                <!--</div>-->
                <div class="form-group">
                  <label for="puppy_category">Breed<span style="color:red;">*</span></label>
                  <select name="puppy_category" id="puppy_category" class="form-control  custom-select" required>
                    <option disabled selected value="">Select Breed</option>
                    <?php
                    foreach ($breed as $breed_key => $breeds) {
                    ?>
                      <option value="<?= $breeds['id'] ?>"><?= $breeds['breed_name'] ?></option>
                    <?php
                    }
                    ?>
                  </select>
                ...
                <div class="form-group">
                  <label for="puppy_sex">Puppy Gender<span style="color:red;">*</span></label><br>

                  <input type="radio" id="male" name="puppy_sex" value="Male">
                  <label for="male">Male</label>
                  <input type="radio" id="female" name="puppy_sex" value="Female">
                  <label for="female">Female</label>
                </div>
                <!-- <div class="form-group">
                  <label for="puppy_age">Puppy Age<span style="color:red;">*</span></label><br>
                  <input type="radio" id="puppy" name="puppy_age" value="Puppy">
                  <label for="puppy">Puppy</label>
                  <input type="radio" id="adult" name="puppy_age" value="Adult">
                ...
                <div id="priceBloc" class="row mb-3">
                  ...
                  <div class="col-md-12">
                    <div class="input-group">
                      <span class="input-group-text">$</span>
                      <input id="ask_price" name="ask_price" class="form-control " placeholder="eg 1000" type="number" min="0" step="0.01" value="">
                      <!-- <span class="input-group-text">
                                <input id="negotiable" name="negotiable" type="checkbox" value="1" >&nbsp; <small>Negotiable</small></span> -->
                    </div>
                  </div>
                ...
                <!-- <div id="priceBloc" class="row mb-3">
                  ...
                  <div class="col-md-12">
                    <div class="input-group">
                      <span class="input-group-text">$</span>
                      <input id="sale_price" name="sale_price" class="form-control " placeholder="eg 1000" type="number" min="0" step="0.01" value="">
                      <span class="input-group-text">
                        <input id="negotiable" name="negotiable" type="checkbox" value="1">&nbsp; <small>Negotiable</small></span>
                    </div>
                  </div>
                </div> -->
                <!-- <input type="button" name="next-step" class="next-step two" value="Next Step" />
                <input type="button" name="previous-step" class="previous-step" value="Previous" />
              </fieldset>
              <fieldset> -->
                <!-- <h2>Puppy Details 2</h2> -->
                <div class="form-group">
                  <label for="puppy_name">Registration<span>(Optional)</span></label><br>


                  
                  <input type="checkbox" name="registration1[]" id="registration1" value="ACA">
                  <label for="registration1">ACA</label><br>
                  <input type="checkbox" name="registration1[]" id="registration2" value="AKC">
                  <label for="registration2">AKC</label><br>

                  <input type="checkbox" name="other_registration" id="other_registration" value="">
                  <label for="other_registration">Other</label><br>
                  <div class="form-group" id="specify_other" style="display:none">
                    <input type="text" class="form-control" id="other_registration_text" placeholder="Specify other">
                  </div>
                </div>
                ...
                <!-- <input type="button" name="next-step" class="next-step three" value="Next Step" />
                <input type="button" name="previous-step" class="previous-step" value="Previous" />
              </fieldset>
              <fieldset> -->
                <br><br>
                ...
                <!-- <div class="form-group">
                  <label for="titleNoti">Select Featured Image/Video</label>
                  <select name="upload_option" id="upload_option" class="form-control custom-select">
                    <option value="">Select Featured Image/Video</option>
                    <option value="1">Featured Image</option>
                    <option value="2">Featured Video</option>
                  </select>
                </div>

                <div id="image_div">
                  <div class="form-group">
                    <label for="titleNoti">Featured Image</label>
                    <input type="file" name="featured_image" class="form-control" id="featured_image" onchange="readURL(this,'#featured');" accept=".png, .jpg, .jpeg" />
                  </div><br>
                  <div class="form-group col-md-6">

                    <img id="featured" src="<?php echo base_url('uploads/upload_logo.png') ?>" width="200" height="150" />


                  </div>
                  <a type="button" id="featured_photo_delete"><i class="fas fa-trash"></i></a>
                </div>
                <div id="video_div">
                  <div class="form-group">
                    <label for="titleNoti">Featured Video</label>
                    <input type="file" name="featured_video" class="form-control" id="featured_video" accept="video/*" />
                  </div>
                  <video controls id="video-tag" height="200px" width="200px">
                ...
                <!-- <div class="form-group">
                  <label for="files" class="files">Image Gallery</label><br>
                  <label for="files" class="btn btn-primary btn-md files">Select Images </label>
                  <input type="file" name="img_gallery[]" id="files" class="form-control show-for-sr files" accept="image/*" multiple>
                ...
                <video controls id="video-tags" height="200px" width="200px">
                  <source id="video-sources" src="splashVideo">
                  Your browser does not support the video tag.
                </video>
                <video controls id="video-tags2" height="200px" width="200px">
                  <source id="video-sources2" src="splashVideo">
                  Your browser does not support the video tag.
                </video>
                ...
                <div class="form-group">
                  ...
                  <input id="youtube" name="youtube" class="form-control" type="url">
                </div>
 ...
 <div class="form-group">
                 <input type="checkbox" name="training_package1" id="training_package" value="1">
                ...
                <!--<input type="button" name="next-step" class="next-step three" value="Continue" />-->
                <!-- <input type="button" name="previous-step" class="previous-step" value="Previous" /> -->
                <!--</fieldset>-->
                <!--<fieldset>-->
                <!--<h2>Go Premium</h2>-->
                <input type="hidden" name="time0" value="0">
                <!--<div class="row mb-3 required">-->
                <!--                                <label class="col-md-3 col-form-label ">Select Premium Plans </label>-->
                <!--                                <div class="col-md-9">-->
                <!--                                    <select class="form-control time_select time_check0" id="0" name="time0">-->
                ...
                <!--         <span><button type="button" class="btn btn-warning" >Apply</button></span>   -->
                <!--    </div>-->
                <!--</div>-->
                <div class="row mb-3">
                  <div class="offset-md-3 col-md-9 newprice">
                    <h4><b></b></h4>

                  </div>
                </div>
                <div class="row mb-3">
                  <div class=" col-md-12 price" style="padding: 22px;
    background: #8cc63f;">
                ...
                <div class="row mb-3">
                  <div class="offset-md-3 col-md-9 priceerror">
                    <h4><b></b></h4>

                  </div>
                </div>

                <input type="hidden" name="total_amount" value="23" id="total_amount">
                <input type="button" name="submit" class="submit btn" id="submit" value="Proceed to Pay" style="background:#8cc63f; color:#fff;width:155px">
                <input type="button" name="add_cart" class="add_cart btn btn-light-blue" style="width:155px" id="add_cart" value="Add to Cart">
  ...
  <div class="form-loading" style="display: none;">
    <div class="loading" data-loading-text="Uploading..."></div>
    <p>Please wait</p>
  ...
  <script>
    ...
    //               <input type="checkbox" value="1"  id="merged" name="merge"  >\
    //                 <span>Show ad in <a href="https://nosheddoodles.com" targer="_blank">Nosheddoodles.com</a></span>');
    //                   $('#promo_code').val('');
    //                   $('.priceerror').empty();  
    //                   }
  ...
  <script type="text/javascript">
    ...
    $('#upload_option').change(function() {
      if ($('#upload_option').val() == '1') {
        ...
        $('#video_div').show();
        $("#featured_image").val('');
        $('#featured').attr('src', '<?php echo base_url('uploads/upload_logo.png') ?>').width(200).height(150);
      }
    });
    ...
    //   $.ajax({
    //     type: "post",
    //     url: "<?= base_url() ?>frontend/AdController/add_cart",
    //     data: data,
    ...
    //     dataType: "json",
    //     success: function(response) {
    //       if (response.status == 'successcomplete') {
    //         $.alert('Ad Posted successfully!!');
    //         window.location.href = "<?= base_url() ?>my_ads";
    //       } else if (response.status == 'fail') {
    //         $('.form-loading').hide();
    //         $.alert('Something went wrong!! Please try again');

    //       } else if (response.status == 'success') {
    //         $.alert('Added to cart! View it in your Cart..Make payment for Ad posting')
    //         window.location.href = "<?= base_url() ?>my_ads";
    //       }
      ...
      $(".next-step").click(function() {
        ...
        if (current == '1') {
          ...
          if ($('#puppy_name').val() == '' || $('#puppy_category').val() == '' || $('#puppy_size').val() == '') {
            ...
            swal('Please select Puppy Gender!!');
            return false;
            //   } else if ($('#ask_price').val() != '' && (parseInt($('#sale_price').val()) > parseInt($('#ask_price').val()))) {
          ...
          //     {
          //         swal('Please enter the registration details!!');
          //     }
          // else
          // {
          currentGfgStep = $(this).parent();
  ...
  <script>
    ...
    function previewFiles() {
      ...
      var $fileUpload = $("#image_gallery");
      if (parseInt($fileUpload.get(0).files.length) > 4) {
        swal("You can only upload a maximum of 4 Images!");
        // $("#preview").remove();
        $("#image_gallery").val('');
        ...
        var files = document.querySelector('#image_gallery').files;
  ...
  <!--    $("#video_gallery").change(function(){-->
  <!--        var $fileUpload = $("#video_gallery");-->
  <!--        if (parseInt($fileUpload.get(0).files.length)>2){-->
  <!--         swal("You can only upload a maximum of 2 Videos!"); -->
  <!--         $("#video_gallery").val('');-->
  <!--        }-->
  <!--    });    -->
  <!--});-->
  ...
  <script>
    $(document).ready(function() {
      $('#ad_type').change(function(e) {
        ...
        var val = $(this).val();
        if (val == '') {
          window.location.replace("<?= base_url() ?>new_post");
        } else {
          window.location.replace("<?= base_url() ?>posts/duplicatead/" + val);
        }
      ...
      $('#father_photo_delete').click(function(e) {
        ...
        document.getElementById("father_photo_value").value = null;
  ...
  <script type="text/javascript">
    $(document).on('change', '.time_select', function(e) {
      ...
      if (val == '') {
        $('#promo_code').val('');
        $('.priceerror').empty();
        if ($('#merged').is(":checked") == true) {
          $('.price').empty();
          $('.newprice').empty();
          $('.price').append('<h4><b>Total :$ ' + 30 + ' </b></h4>');
          $('#total_amount').val('30');
        } else {
          $('.price').empty();
          $('.newprice').empty();
          $('.price').append('<h4><b>Total :$ ' + 19 + ' </b></h4>');
          $('#total_amount').val('19');
        }
      } else {
    ...
    function get_price() {
      ...
      $.ajax({
        type: "post",
        url: "<?= base_url() ?>frontend/AdController/get_price",
        data: data,
        processData: false, // Important!
        contentType: false,
        cache: false,
        ...
        success: function(response) {
          ...
          $('.newprice').append('<h4>Base Price :$ ' + response.base + ' + <b style="color:red;"> $' + response.extra + ' </b></h4>');
    ...
    function get_discount_price() {
      ...
      $.ajax({
        type: "post",
        url: "<?= base_url() ?>frontend/AdController/getdiscountprice",
        data: data,
        processData: false, // Important!
        contentType: false,
        cache: false,
        ...
        success: function(response) {
          ...
          if (isNaN(response.msg)) {
            $('#promo_code').val('');
            $('.priceerror').empty();
            $('.priceerror').append('<h4 style="color:red;"><b>' + response.msg + ' </b></h4>');

          } else {
            $('.price').append('<h4><b>Total :$ ' + response.msg + ' </b></h4>');

            $('#total_amount').val(response.msg);
            if (response.offer == 100) {
              $('.priceerror').append('<h4 style="color:green;"><b> You got 100% off!! </b></h4>');
            }
          }
          ...
          if (filesLength <= 10) {
            for (var i = 0; i < filesLength; i++) {
              ...
              fileReader.onload = (function(e) {
                var file = e.target;
                $('#sortable').append("<span class=\"pip\">" +
    ...
    $(document).ready(function() {
      ...
      myDropzone.on("success", function(file, message) {
        ...
        if (resp.status == 'success') {
          if (resp.url == 1) {
             window.location.replace("<?= base_url() ?>my-cart");
          } else {
      ...
      myDropzone.on("error", function(data) {
           $('.form-loading').hide();
          swal('There is some thing wrong, Please try again!');
 ...
 if(myDropzone.getQueuedFiles().length>=3)
 {
        if (validateOnSubmit() == true) {
          ...
          myDropzone.on("processing", function(file) {
            myDropzone.options.url = "<?= base_url() ?>frontend/AdController/add_cart";
          });
          ...
          swal('Minimum 3 Images Required');
      }
      });
 ...
 if(myDropzone.getQueuedFiles().length>=3)
 {
        if (validateOnSubmit() == true) {
          $('.form-loading').show();
          myDropzone.on("processing", function(file) {
            myDropzone.options.url = "<?= base_url() ?>addad";
          });
