  ...
  <div class="main-container">
            ...
            <form id="form" method="POST" action="<?= base_url() ?>posts/editad/<?= $post->id ?>" enctype="multipart/form-data">
              ...
              <fieldset>
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <a href="<?= base_url() ?>new_post">
                      <button type="button" class="btn " style="background-color:#8cc63f; color:#fff">New Ad</button>
                    </a>
                  </div>
                </div>
               ...
               <?php if(!empty($breeder->state_id)){ ?>
                ...
                <!--<div id="priceBloc" class="row mb-3">-->
                <!--    <label class="col-md-3 col-form-label" for="sale_price">Sale Price<span style="color:red;"></span></label>-->
                <!--    <div class="col-md-12">-->
                <!--        <div class="input-group">-->
                <!--            <span class="input-group-text">$</span>-->
                <!--            <input id="sale_price" name="sale_price" class="form-control " placeholder="eg 1000" type="number" min="0" step="0.01" value="<?= $post->price ?>">-->
                <!--            <span class="input-group-text">-->
                <!--            <input id="negotiable" name="negotiable" type="checkbox" <?php if ($post->negotiable == '1') { ?> checked <?php } ?> value="1" >&nbsp; <small>Negotiable</small></span>-->
                <!--        </div> -->
                <!--    </div>-->
                <!--</div>  -->
                <!-- <input type="button" name="next-step" 
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group col-md-6" id="lightgallery_mother">
                      ...
                      ?>
                        ...
                        <input type="hidden" name="mothers" id="mothers" value="<?= $post->mother_photo ?>">
                      <?php
                      }
                      ?>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group col-md-6" id="lightgallery_father">
                      ...
                      ?>
                        ...
                        <input type="hidden" name="fathers" id="fathers" value="<?= $post->father_photo ?>">
             ...
             <label for="titleNoti"> (You can drag photos to reorder them. The first photo will appear as the cover.)</label>
                ...
                <div class="form-group mt-5" id="merge">
                  ...
                  <input type="hidden" value="0" name="time0">
    ...
    background: #8cc63f;">
                  ...
                  if ($post->is_merged == 1) {
                  ?>
                    <input type="hidden" name="total_amount" value="30" id="total_amount">
                  <?php
                  } else {
                  ?>
                  ...
                  ?>
                  <input type="button" name="submit" class="submit" id="submit" value="Proceed to Pay" style="background-color: #8cc63f; color: #fff;">
                  <input type="button" name="add_cart" class="add_cart btn-light-blue" id="add_cart" value="Add to Cart">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      //   $.ajax({
      //     type: "post",
      //     url: "<?= base_url() ?>frontend/AdController/add_cart_duplicate",
      //     data: data,
      ...
      //         swal('Ad Posted successfully!!')
      //       } else {
      //         swal('Added to cart! View it in your Cart..Make payment for Ad posting')
  ...
  <script>
    $('.delete').click(function() {
      var id = $('#post_id').val();
      var status = $(this).parent().next().find(":input").val();
      alert(status);
      $.ajax({
        type: "post",
        ...
        success: function(data) {
          console.log(data);
          document.getElementById("file-ip-" + status + "-preview").src = "<?php echo base_url('uploads/upload_logo.png') ?>";
        }
      });
    });
    ...
    $(document).on('change', '.time_select', function(e) {
      ...
      if (val == '') {
        ...
        if ($('#merged').is(":checked") == true) {
          ...
          $('.price').empty();
          $('.newprice').empty();
          $('.price').append('<h4><b>Total :$ ' + 23 + ' </b></h4>');
          $('#total_amount').val('19');
        }
      } else {
 ...
 if(myDropzone.getQueuedFiles().length>=3)
 {
        ...
        myDropzone.on("processing", function(file) {
          myDropzone.options.url = "<?= base_url() ?>frontend/AdController/add_cart_duplicate";
        });
