...
<svg style="max-height: 150px;"  viewBox="0 0 87 87" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <div class="success-message__content">
       ...
       <a href="<?=base_url()?>my_ads"> <button class="btn btn-primary">Go To My Ads</button></a>
       <a href="<?=base_url()?>premium_ads"> <button class="btn btn-info">Go To Premium Ads</button>
    </div>
</div>
