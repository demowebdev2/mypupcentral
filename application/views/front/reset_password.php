    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-8 col-sm-10 col-12 login-box mt-2">
                <form id="loginForm" role="form" method="POST" action="<?= base_url() ?>Home/update_password/<?=$token?>">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="panel-intro">
                            <div class="d-flex justify-content-center">
                                <h2 class="logo-title"><strong>Reset Password</strong></h2>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group show-pwd-group">
                                    <span class="input-group-text"><i class="icon-lock fa"></i></span>
                                    <input id="password" name="cpassword" type="password" class="form-control" placeholder="Password" autocomplete="off">
                                    <span class="icon-append show-pwd">
                                        <button type="button" class="eyeOfPwd">
                                            <i class="far fa-eye-slash"></i>
                                        </button>
