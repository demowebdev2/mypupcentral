<style>
    ...
    .incss-cust-ol{
text-align:left; font-size: 16px; line-height: 35px;
}
.incss-cust-ol-li{
padding-right: 10px;color:#a6e1ff;
}
...
<section>
    <img  src="<?= base_url() ?>assets/lazyload.gif" data-src="<?=base_url()?>assets/sta_banner.jpg" class="w-100">
</section>
                ...
                <div class="col-md-6 col-sm-6 equal-height">
                    <div class="item">
                        ...
                        <div class="info">
                            ...
                            <ol class="incss-cust-ol">
                                <li><i class="fa fa-check-circle incss-cust-ol-li" aria-hidden="true"></i> I will ensure every puppy has been well socialized and is prepared to join a new family.</li>
                                <li><i class="fa fa-check-circle incss-cust-ol-li" aria-hidden="true"></i> I will ensure every puppy is healthy and has been properly examined by a licensed veterinarian. </li>
                                <li><i class="fa fa-check-circle incss-cust-ol-li" aria-hidden="true"></i> I will maintain a safe, clean, and sanitary environment for my adult dogs and puppies.</li>
                                <li><i class="fa fa-check-circle incss-cust-ol-li" aria-hidden="true"></i> I will provide each buyer with health records- including vaccination and deworming records and basic diet information. </li>
